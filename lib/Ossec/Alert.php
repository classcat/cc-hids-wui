...
class Ossec_Alert {
    ...
    function toHtml( ) {
        ...
        <div class="alert $class">
            ...
            <div class="alertindent">レベル: </div><div class="alertlevel">{$this->level} - <span class="alertdescription">{$this->description}</span></div>
            <div class="alertindent">ルール Id: </div>$id_link <br />
            <div class="alertindent">ログファイル: </div>{$this->location}<br />
            $srcip
            $user
