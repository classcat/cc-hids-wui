...
<table><tr valign="top">
<td>
エージェント名: </td><td><select name="agentpattern" class="formText">';
...
// echo '<td><input type="submit" name="ss" value="Dump database" class="button"/>;
echo '<td><button type="submit" name="ss" value="Dump database" class="button">データベースのダンプ</button>';
...
/* Last modified files */
echo "<br /><h2>最近変更されたファイル(すべてのエージェントについて): </h2>\n\n";
      ...
      isset($syscheck_list{'global_list'}{'files'}))
   {
       ...
       foreach($syscheck_list{'global_list'}{'files'} as $syscheck)
       {
           ...
           echo '
               ...
               <br />
               <div class="smaller">
               &nbsp;&nbsp;<b>ファイル:</b> '.$ffile_name.'<br />';
               if($ffile_name2 != "")
               {
                   echo "&nbsp;&nbsp;&nbsp;&nbsp;".$ffile_name2.'<br />';
               }
               echo '
               &nbsp;&nbsp;<b>エージェント:</b> '.$syscheck[1].'<br />
               &nbsp;&nbsp;<b>変更時刻:</b> '.
